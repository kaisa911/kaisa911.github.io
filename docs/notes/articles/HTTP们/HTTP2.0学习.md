...
* SPDY旨在通过基本（始终启用）和高级（可选启用）功能实现更低的延迟。
 ![在这里插入图片描述](https://img-blog.csdnimg.cn/20200709095731715.png) 

二、HTTP2.0的特点
2.1 二进制传输
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200709100218590.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTQ2Mjc4MDc=,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200709100229423.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTQ2Mjc4MDc=,size_16,color_FFFFFF,t_70#pic_center)
